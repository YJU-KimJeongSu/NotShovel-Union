...
export default {
  ...
  async beforeDestroy() {
    ...
    if ((this.title == null || this.title == "")
      ...
      await axios.delete(`https://${process.env.VUE_APP_SERVER_URL}/api/meeting?board_id=${this.board_id}&meetingMinuteId=${meetingMinuteId}`, {
  ...
  methods: {
    ...
    async save() {
      ...
      try {
        ...
        await axios.patch(`https://${process.env.VUE_APP_SERVER_URL}/api/meeting`, {
          board_id,
          title: this.title,
          date: this.date,
    ...
    loadSavedMeetingMinute(meetingMinute) {
      ...
      axios.get(`https://${process.env.VUE_APP_SERVER_URL}/api/meeting/chat`, {
        params: {
      ...
      if (this.context !== "") {
        ...
        this.socket.emit("new_message", chat, () => {
          this.$nextTick(() => {
            ...
            axios.post(`https://${process.env.VUE_APP_SERVER_URL}/api/meeting/chat`, chat, {
              headers: this.$store.getters.headers
            })
