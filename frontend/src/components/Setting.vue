  ...
  methods: {
    ...
    async updateProject() {
      try {
        ...
        await axios.patch(`https://${process.env.VUE_APP_SERVER_URL}/api/project`, {
    ...
    async saveImage() {
      try {
        ...
        const { data } = await axios.get(`https://${process.env.VUE_APP_SERVER_URL}/api/s3/url`, {
          params: { filename },
          headers: this.$store.getters.headers
        });
    ...
    async chkPw() {
      try {
        await axios.post(`https://${process.env.VUE_APP_SERVER_URL}/api/member/chkPw`, {
    ...
    async deleteProject() {
      ...
      try {
        ...
        if (chk) {
          await this.chkPw();
          await axios.delete(`https://${process.env.VUE_APP_SERVER_URL}/api/project`, {
    ...
    async getMember() {
      try {
        const response = await axios.get(`https://${process.env.VUE_APP_SERVER_URL}/api/project/members`, {
          params: {
            project_id: this.project.id
          },
          headers: this.$store.getters.headers
    ...
    async changeGrade(currentGrade, id) {
      ...
      try {
        const result = await axios.post(`https://${process.env.VUE_APP_SERVER_URL}/api/project/grade`, {
          project_id: this.project.id,
          member_id: id,
          grade: changeGrade,
        }, {
